@extends('admin::beagle.app')
@section('content')

    
        
            <div class="main-content container-fluid">
                <div class="splash-container col-3">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{route('admin.login')}}">
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="username" type="text" name="name"  value="admin">
                                    @if($errors->has('email'))
                                    <div class="text-danger">*邮箱不能为空</div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="password" type="password" name="password" placeholder="密码" value="admin888">
